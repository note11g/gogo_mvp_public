...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, String profileImageUrl, SomaRole somaRole});
}
...
class _$_User with DiagnosticableTreeMixin implements _User {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'User(id: $id, name: $name, profileImageUrl: $profileImageUrl, somaRole: $somaRole)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      required final SomaRole somaRole}) = _$_User;
